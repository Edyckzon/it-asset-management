...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        { name: "Áreas", path: "/rrhh/areas" },
        { name: "Empleados", path: "/rrhh/empleados" },
        { name: "Equipos", path: "/rrhh/equipos", new: true },
        { name: "Credenciales", path: "/rrhh/credenciales" },
      ],
    },
    {
    ...
    {
      name: "Forms",
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" ...</svg>`,
  ...
  // Others nav items
  othersItems: NavItem[] = [
    /* === MÓDULOS OTHERS OCULTOS POR AHORA ===
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" ...</svg>`,
      name: "Charts",
      subItems: [
